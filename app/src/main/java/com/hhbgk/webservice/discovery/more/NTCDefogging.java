...
public class NTCDefogging extends AttributeContainer implements KvmSerializable
{
    ...
    public NTCDefoggingExtension Extension;

    public NTCDefogging ()
    {
    }

    public NTCDefogging (Object paramObj,NTCExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("Extension"))
                {
                    ...
                    {
                        Object j = obj;
                        this.Extension = (NTCDefoggingExtension)__envelope.get(j,NTCDefoggingExtension.class,false);
                    }
                    continue;
                }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==2)
        {
            info.type = NTCDefoggingExtension.class;
            info.name = "Extension";
            info.namespace= "http://www.onvif.org/ver10/schema";
        }
    }
