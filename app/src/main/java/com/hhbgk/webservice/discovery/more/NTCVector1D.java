...
public class NTCVector1D extends AttributeContainer implements KvmSerializable
{
    ...
    public NTCVector1D (Object paramObj,NTCExtendedSoapSerializationEnvelope __envelope)
    {
