...
public class NTCFocusConfiguration extends AttributeContainer implements KvmSerializable
{
    ...
    public NTCFocusConfiguration ()
    {
    }

    public NTCFocusConfiguration (Object paramObj,NTCExtendedSoapSerializationEnvelope __envelope)
    {
