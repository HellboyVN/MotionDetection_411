...
public class NTCVideoResolution2 extends AttributeContainer implements KvmSerializable
{
    ...
    public NTCVideoResolution2 ()
    {
    }

    public NTCVideoResolution2 (Object paramObj,NTCExtendedSoapSerializationEnvelope __envelope)
    {
