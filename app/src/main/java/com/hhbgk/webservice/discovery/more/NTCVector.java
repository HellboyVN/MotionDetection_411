...
public class NTCVector extends AttributeContainer implements KvmSerializable
{
    ...
    public NTCVector (Object paramObj,NTCExtendedSoapSerializationEnvelope __envelope)
    {
